...
//This class is used to create a Meeting in the Database via an AppDatabase Object
public class CreateMeeting extends AsyncTask<Meeting, Void, Void> {

    private AppDatabase database;
    private OnAsyncEventListener callback;
    private Exception exception;
    //This method is used to create a Meeting using the getInstance method
    public CreateMeeting(Context context, OnAsyncEventListener callback) {
