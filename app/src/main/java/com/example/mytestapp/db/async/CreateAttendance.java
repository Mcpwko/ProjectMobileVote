...
//This class is used to create an attendance in the Database via an AppDatabase Object
...
public class CreateAttendance extends AsyncTask<Attendance, Void, Void> {
    ...
    //This method is used to create an attendance using the getInstance method
